...
order: 2
description: A different metaphysics, ethics and spiritual path than the Christian one I am used to, but it makes a lot of sense
types: Philosophy
publishDate: 2026-08-13
---

![Book cover](Images/image-3.png)

![Bhagavad Gita note tree — Metaphysics](Images/note-tree-metaphysics.png)

![Bhagavad Gita note tree — The Human Condition, part 1](Images/note-tree-human-condition-1.png)

![Bhagavad Gita note tree — The Human Condition, part 2](Images/note-tree-human-condition-2.png)

![Bhagavad Gita note tree — The Human Condition, part 3](Images/note-tree-human-condition-3.png)

![Bhagavad Gita note tree — The Spiritual Path, part 1](Images/note-tree-spiritual-path-1.png)

![Bhagavad Gita note tree — The Spiritual Path, part 2](Images/note-tree-spiritual-path-2.png)
...
- [Moral nature] [The soul is neither good nor bad] The soul (*ātman*) is intrinsically spiritual and pure. Moral corruption belongs to conditioned consciousness and action, not to the soul's essence: soul ≠ character.
  - [MYTAKE] [Christianity believes in transformation of the soul while Hinduism treats it as immutable] In Christianity, the soul can be spiritually and morally transformed by sin, grace, and sanctification; after death, it is judged and sent to heaven or hell. In Hinduism, the soul itself is immutable. 
  - [MYTAKE] [I cannot see any practical difference] in how people live from these premises, but the metaphysical difference interests me.
...
![Karmic bondage cycle](Images/image.png)
