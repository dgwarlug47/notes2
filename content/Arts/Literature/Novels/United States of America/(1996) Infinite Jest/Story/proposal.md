...
![Basics and plot note tree for Infinite Jest](note-tree/note-tree-basics-plot.png)

![Philosophy and American politics note tree for Infinite Jest](note-tree/note-tree-philosophy-american-politics.png)

![Addiction note tree for Infinite Jest](note-tree/note-tree-addiction.png)

![Tennis note tree for Infinite Jest](note-tree/note-tree-tennis.png)

![Style note tree for Infinite Jest](note-tree/note-tree-style.png)

![Terrorists note tree for Infinite Jest](note-tree/note-tree-terrorists.png)
...
| *Hamlet* | *Infinite Jest* | Function of the Parallel |
|---|---|---|
| **Hamlet** | **Hal Incandenza** | Brilliant, alienated son whose inner life cannot fully reach the outside world. |
| **King Hamlet / Ghost** | **James Incandenza / JOI** | Dead father whose hidden presence continues to shape the son and the plot. |
| **Gertrude** | **Avril Incandenza** | Mother figure whose sexuality and intimacy with the uncle-like figure disturb the family structure. |
| **Claudius** | **Charles Tavis** | Uncle-like figure associated with Avril after James’s death, though not a direct murderer-usurper. |
| **Play-within-the-play** | **The Entertainment** | Art object that reveals the central problem: in *Hamlet*, hidden guilt; in *Infinite Jest*, that our society is based on hedonism. |
...
- [Quote] [Foreshadowing] "I think of John N.R. Wayne, who would have won this year’s WhataBurger, standing watch in a mask as Donald Gately and I dig up my father’s head."
